...
class DemoPopulation extends React.Component {
	constructor(props) {
		super(props);
		this.state = {
			min_value: 0,
	...
	render() {
		...
		return(
				<div>
			     		<div>
					        <div className="add-filter-instructions">Select a range of the population</div>
					        <div className="selected-range">{min_value} - {max_value}  Population</div>
